...
class DatabaseSeeder extends Seeder {
    ...
    public function run()
    {
        ...
        $this->call(ChatFilesTableSeeder::class);
        $this->call(ChatRelationsTableSeeder::class);
        $this->call(CountriesTableSeeder::class);
        $this->call(EmailHistoriesTableSeeder::class);
        $this->call(EmailListsTableSeeder::class);
        ...
        $this->call(CancelOrdersTableSeeder::class);
       // $this->call(SuspendsTableSeeder::class);
        $this->call(WishListsTableSeeder::class);
        $this->call(RatingsTableSeeder::class);
        $this->call(AdminEarningsTableSeeder::class);
    }
